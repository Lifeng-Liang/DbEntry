...
namespace Leafing.UnitTest.util {
    ...
    public class ConfigTest1 {
        ...
        public static readonly int TestInt2 = 0;
    ...
    public static class ConfigTest2 {
        ...
        static ConfigTest2() {
            ConfigReader.Config.AppSettings.InitClass(typeof(ConfigTest2));
        }
    }
    ...
    public static class ConfigTest3 {
        ...
        static ConfigTest3() {
            ConfigReader.Config.AppSettings.InitClass(typeof(ConfigTest3));
        }
    }
}