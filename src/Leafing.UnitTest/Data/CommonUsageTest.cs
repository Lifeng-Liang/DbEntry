...
using Leafing.UnitTest.Data.CreateTable;
...
namespace Leafing.UnitTest.Data
{
    ...
    public class CommonUsageTest : DataTestBase
    {
        ...
        {
            ObjectInfo oi = ModelContext.GetInstance(typeof(LeafingLog)).Info;
            Assert.AreEqual("System_Log", oi.From.MainTableName);

            oi = ModelContext.GetInstance(typeof(LeafingEnum)).Info;
            Assert.AreEqual("Leafing_Enum", oi.From.MainTableName);
        }
