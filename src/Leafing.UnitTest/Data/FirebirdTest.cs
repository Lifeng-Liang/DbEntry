...
namespace Leafing.UnitTest.Data {
    ...
    public class FirebirdTest {
        ...
        public void TestCreate() {
            ...
            Assert.AreEqual("CREATE GENERATOR GEN_LEAFING_ENUM2_ID;<Text><30>()", StaticRecorder.Messages[1]);
        }
        ...
        public void TestDrop() {
            ...
            Assert.AreEqual("DROP GENERATOR GEN_LEAFING_ENUM2_ID;<Text><30>()", StaticRecorder.Messages[1]);
        }
    }
}