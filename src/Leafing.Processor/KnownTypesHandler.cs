...
using Leafing.Core;
using Mono.Cecil;
using DataException = Leafing.Data.DataException;
using SpecialNameAttribute = Leafing.Data.Definition.SpecialNameAttribute;

namespace Leafing.Processor
{
    public class KnownTypesHandler
    {
        public static readonly string LeafingData = typeof(DbEntry).Assembly.FullName;
        ...
        private readonly MethodReference _instanceHandler;
        ...
        public KnownTypesHandler(ModuleDefinition module)
        {
            ...
            _instanceHandler = Import(Import(typeof(InstanceHandlerAttribute)).GetConstructor(typeof(Type)));
        ...
        private static TypeReference GetKeyType(TypeReference model)
        {
            ...
            if (model.IsGenericInstance && model.Namespace == "Leafing.Data.Definition")
            {
        ...
        {
            var r = new CustomAttribute(_instanceHandler);
