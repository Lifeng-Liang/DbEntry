...
namespace Leafing.Data.Model.Handler.Generator
{
    public class MemoryAssembly
    {
		...
		public const string DefaultDllName = DefaultAssemblyName + ".dll";
        ...
        {
			InnerModule = InnerAssembly.DefineDynamicModule(AssemblyName, DefaultDllName);
        }

        public void Save()
        {
			InnerAssembly.Save(DefaultDllName);
        }
    }
}
