...
namespace Leafing.Web
{
    public class DbEntryMembershipProvider : MembershipProvider
    {
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            if (u != null && Util.AreEqual(u.Password, StringHelper.Hash(oldPassword)))
            {
        ...
        public override string GetPassword(string username, string answer)
        {
            ...
            if (u != null)
            {
                if (Util.AreEqual(u.PasswordAnswer, StringHelper.Hash(answer)))
                {
                    return "";
                }
            }
        ...
        public override string ResetPassword(string username, string answer)
        {
            ...
            if (u != null)
            {
                if (!RequiresQuestionAndAnswer || Util.AreEqual(u.PasswordAnswer, StringHelper.Hash(answer)))
                {
        ...
        {
            var u = DbEntryMembershipUser.FindOne(CK.K["UserName"] == username);
            if(u != null && Util.AreEqual(u.Password, StringHelper.Hash(password)))
            {
                return u;
            }
            return null;
